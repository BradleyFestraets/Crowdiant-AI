    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="flex cursor-not-allowed items-center gap-3 rounded-lg border bg-gray-50 p-4 opacity-50">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Details about your venue</CardDescription>
        </CardHeader>
        <CardContent>
